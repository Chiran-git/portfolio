    ...
    <section class="py-12 bg-white">
      <div class="container mx-auto px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <!-- Tools & Platforms -->
          <div>
            <h2 class="text-2xl font-bold text-gray-900 mb-6">{{ t('skills.tools') }}</h2>
            <div class="space-y-6">
          ...
          <!-- Testing & Deployment -->
          <div>
            <h2 class="text-2xl font-bold text-gray-900 mb-6">{{ t('skills.testing') }}</h2>
            <div class="space-y-6">
          ...
          <!-- Others -->
          <div>
            <h2 class="text-2xl font-bold text-gray-900 mb-6">{{ t('skills.others') }}</h2>
            <div class="space-y-6">
